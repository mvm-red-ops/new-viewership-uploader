-- ==============================================================================
-- Create platform_viewership table in NOSEY_PROD
-- This is the processing database where Lambda moves data from UPLOAD_DB_PROD
-- ==============================================================================

-- Create sequence for ID column
CREATE SEQUENCE IF NOT EXISTS nosey_prod.public.platform_viewership_id_seq
    START = 1
    INCREMENT = 1;

-- Create platform_viewership table
CREATE TABLE IF NOT EXISTS nosey_prod.public.platform_viewership (
    -- Primary Key
    ID NUMBER DEFAULT nosey_prod.public.platform_viewership_id_seq.NEXTVAL NOT NULL,
...
WHERE table_name = 'PLATFORM_VIEWERSHIP' AND table_schema = 'PUBLIC';
