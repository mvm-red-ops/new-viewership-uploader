...
Direct deployment without streamlit config
"""
import os
import sys
import snowflake.connector

def deploy_file(conn, cursor, file_path):
...
def main():
    ...
    user = os.environ.get('SNOWFLAKE_USER') or input("Snowflake user: ")
    password = os.environ.get('SNOWFLAKE_PASSWORD') or input("Snowflake password: ")
    account = os.environ.get('SNOWFLAKE_ACCOUNT') or 'nosey'
