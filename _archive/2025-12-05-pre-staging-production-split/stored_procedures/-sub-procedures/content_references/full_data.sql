CREATE OR REPLACE PROCEDURE upload_db.public.process_viewership_full_data(
    platform VARCHAR,
    filename VARCHAR
)
    RETURNS STRING
...
try {
    ...
    try {
        ...
        try {
            ...
            // const conflictTypeForBucket = "Viewership title does match ref_id, series, or ep/season #";
