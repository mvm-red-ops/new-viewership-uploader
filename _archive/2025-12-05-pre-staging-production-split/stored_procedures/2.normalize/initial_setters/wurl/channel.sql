...
select * from dictionary.public.channel_map;
insert into dictionary.public.channel_map(name, entry, channel_id) values 
('Presented by Nosey', 'Presented by Nosey', 17);
