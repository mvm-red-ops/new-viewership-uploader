-- Generic Normalize Data in Staging Wrapper (STAGING VERSION)
...
CREATE OR REPLACE PROCEDURE UPLOAD_DB.PUBLIC.NORMALIZE_DATA_IN_STAGING_GENERIC(
    platform STRING,
    filename STRING
)
RETURNS STRING
...
-- Grant permissions
GRANT USAGE ON PROCEDURE UPLOAD_DB.PUBLIC.NORMALIZE_DATA_IN_STAGING_GENERIC(STRING, STRING) TO ROLE web_app;
