...
CREATE OR REPLACE PROCEDURE UPLOAD_DB_PROD.PUBLIC.NORMALIZE_DATA_IN_STAGING(
    platform STRING,
    filename STRING
)
RETURNS STRING
...
-- Grant permissions
GRANT USAGE ON PROCEDURE UPLOAD_DB_PROD.PUBLIC.NORMALIZE_DATA_IN_STAGING(STRING, STRING) TO ROLE web_app;
