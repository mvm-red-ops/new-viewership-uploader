...
CREATE OR REPLACE PROCEDURE UPLOAD_DB_PROD.public.calculate_viewership_metrics(
    "PLATFORM" VARCHAR,
    "FILENAME" VARCHAR
)
RETURNS VARCHAR
...
GRANT USAGE ON PROCEDURE UPLOAD_DB_PROD.public.calculate_viewership_metrics(VARCHAR, VARCHAR) TO ROLE web_app;
